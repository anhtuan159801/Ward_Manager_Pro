...
export const mockResidents: Resident[] = [
  { id: 'RES001', name: 'Nguyễn Văn An', address: '123 Đường ABC, Phường 1', phone: '0901234567', joinedDate: '2022-01-15', avatarUrl: 'https://picsum.photos/seed/1/40/40' },
  { id: 'RES002', name: 'Trần Thị Bình', address: '456 Đường XYZ, Phường 2', phone: '0912345678', joinedDate: '2021-11-20', avatarUrl: 'https://picsum.photos/seed/2/40/40' },
  { id: 'RES003', name: 'Lê Văn Cường', address: '789 Đường LMN, Phường 1', phone: '0987654321', joinedDate: '2023-03-10', avatarUrl: 'https://picsum.photos/seed/3/40/40' },
  { id: 'RES004', name: 'Phạm Thị Dung', address: '101 Đường PQR, Phường 3', phone: '0934567890', joinedDate: '2020-07-22', avatarUrl: 'https://picsum.photos/seed/4/40/40' },
  { id: 'RES005', name: 'Hoàng Văn Em', address: '212 Đường STU, Phường 2', phone: '0945678901', joinedDate: '2022-08-30', avatarUrl: 'https://picsum.photos/seed/5/40/40' },
];
